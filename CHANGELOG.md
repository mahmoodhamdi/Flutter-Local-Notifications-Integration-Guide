...
### Added
- **Phase 6: Deep Linking & Media Style**
  - DeepLinkHelper for smart navigation from notifications
  - Support for page, message, and action payload types
  - Media style notifications for music/audio apps
  - Simple and full media notification methods
  - Media button for testing in home page

### Changed
- Updated Android SDK to 36 (required by shared_preferences)
- Updated home page to use DeepLinkHelper for notification handling
